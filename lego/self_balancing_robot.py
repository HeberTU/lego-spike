...
Licence,
"""
from spike import PrimeHub, LightMatrix, Button, MotionSensor, MotorPair
...
class PID(object):
    ...
    def __init__(self, KP: int, KI: int, KD: float, max_integral: float = 100):
        """Create an instance of PID class
    ...
    def act(self, set_point: float, state: float, dt: float = None) -> float:
        """Generate an actuator signal based on the inputs.
    ...
    def _now_ms(self) -> float:
        """Get curren time in milliseconds.
